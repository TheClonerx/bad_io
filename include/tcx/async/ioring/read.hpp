...
namespace impl {
    ...
    struct ioring_read_operation {
        ...
        static void call(E &executor, tcx::ioring_service &service, tcx::native::handle_type fd, void *buf, std::size_t len, off_t offset, F &&f)
        {
            using variant_type = std::variant<std::error_code, result_type>;

            service.async_read(fd, buf, len, offset, [&executor, f = std::forward<F>(f)](tcx::ioring_service &, std::int32_t result) mutable {
...
auto async_read(E &executor, tcx::ioring_service &service, tcx::native::handle_type fd, void *buf, std::size_t len, off_t offset, F &&f)
{
...
template <typename E, typename F>
requires tcx::completion_handler<F, tcx::impl::ioring_read_operation::result_type>
auto async_read(E &executor, tcx::ioring_service &service, tcx::native::handle_type fd, void *buf, std::size_t len, F &&f)
{
...
requires tcx::completion_handler<F, tcx::impl::ioring_read_operation::result_type>
auto async_read(E &executor, tcx::ioring_service &service, tcx::native::handle_type fd, std::span<std::byte> bytes, off_t offset, F &&f)
{
...
template <typename E, typename F, std::size_t Extent>
requires tcx::completion_handler<F, tcx::impl::ioring_read_operation::result_type>
auto async_read(E &executor, tcx::ioring_service &service, tcx::native::handle_type fd, std::span<std::byte> bytes, F &&f)
{
