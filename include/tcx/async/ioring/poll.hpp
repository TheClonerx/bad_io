...
namespace impl {
    ...
    struct ioring_poll_operation {
        ...
        static void call(E &executor, tcx::ioring_service &service, tcx::native::handle_type fd, std::uint32_t events, F &&f)
        {
...
auto async_poll(E &executor, tcx::ioring_service &service, tcx::native::handle_type fd, std::uint32_t events, F &&f)
{
